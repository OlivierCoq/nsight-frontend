                  ...
                  <v-card variant="tonal" class="mt-5">
                    ...
                    <v-card-text>
                      ...
                      <v-form v-if="state.stripe_data.cardElement">
                        <v-row>
                          <v-col>
                            <v-text-field v-model="state.new_card.name" label="Name on Card" required dense
                              hide-details></v-text-field>
                            <v-text-field v-model="state.new_card.address.line1" label="Address Line 1" required dense
                              hide-details></v-text-field>
                            <v-text-field v-model="state.new_card.address.line2" label="Address Line 2" dense
                              hide-details></v-text-field>
                          </v-col>
                        </v-row>
                        <v-row>
                          <v-col>
                            <v-text-field v-model="state.new_card.address.city" label="City" required dense
                              hide-details></v-text-field>
                          </v-col>
                          <v-col>
                            <v-text-field v-model="state.new_card.address.state" label="State" required dense
                              hide-details></v-text-field>
                          </v-col>
                          <v-col>
                            <v-text-field v-model="state.new_card.address.postal_code" label="Postal Code" required dense
                              hide-details></v-text-field>
                          </v-col>
                        </v-row>
                        <v-row>
                          <v-col>
                            <v-text-field v-model="state.new_card.address.country" label="Country" required dense
                              hide-details></v-text-field>
                          </v-col>
                        </v-row>
                        <v-row>
        ...
        <v-col cols="12" md="6" v-for="(payment_method, a) in auth.user.payment_methods.data" :key="a">
          <v-card
            ...
            <v-card-actions>
              ...
              <v-btn v-if="auth.user.selected_payment_method.id !== payment_method.id" color="primary" size="small" text
