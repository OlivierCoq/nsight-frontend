<template>
  <v-card variant="tonal">
                ...
                <v-form>
                  <v-row>
                    <v-col cols="12" sm="12" md="12" lg="12" xl="12">
                      <v-text-field v-model="state.address.new_address.name" label="Name" outlined dense hide-details />
                    </v-col>
                    <v-col cols="12" sm="12" md="12" lg="12" xl="12">
    ...
    <v-card-text>
      <v-container>
        <v-row>
          <v-col v-if="!auth.user.addresses || !auth.user.addresses.data.length">
          ...
          <v-col v-else v-for="(address, a) in auth.user.addresses.data" :key="a" cols="12" sm="12" md="5" lg="5" xl="5">
            <div class="ctr-address px-3 w-100 py-4 me-3 d-flex flex-column align-start justify-start"
              ...
              <div class="w-100 d-flex flex-row justify-start align-start">
                      ...
                      <v-card-text>
                        <v-col>
                          <v-form>
                            <v-row>
                              <v-col cols="12" sm="12" md="12" lg="12" xl="12">
                                <v-text-field v-model="state.address.edit_address.name" label="Name" outlined dense
                                  hide-details />
                              </v-col>
                              <v-col cols="12" sm="12" md="12" lg="12" xl="12">
                              ...
                              <v-col cols="12" sm="12" md="12" lg="12" xl="12">
                                <v-text-field v-model="state.address.edit_addressaddstal_zip_code" label="Zip" outlined
                                  dense hide-details />
                              </v-col>
                            </v-row>
                          </v-form>
                ...
                <v-btn v-if="address.street !== auth.user.selected_address.street" color="primary" size="x-small"
                  class="mt-3 ms-3" text @click="set_address_default(address)">
                  Default
                </v-btn>
              </div>
            </div>
