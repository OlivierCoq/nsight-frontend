<template>
  <div id="appBar">
    <v-app-bar
      v-if="authData.user"
      :class="authData.user.preferences[0].dark_mode ? 'dark' : ''"
    >
      ...
      <v-toolbar-title>
        <NuxtLink
          ...
          :class="
            authData.user.preferences[0].dark_mode ? 'text-white' : 'text-dark'
          "
        >
      ...
      <font-awesome-icon
        ...
        class="mx-4 btn-search"
        @click="toggleSearch"
      >
        <v-tooltip activator="parent" location="bottom" open-delay="500"
          >Search products, users, and more</v-tooltip
        >
      </font-awesome-icon>
      <NuxtLink
        to="/account"
