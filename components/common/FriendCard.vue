<template>
  <div class="flex gap-4 items-center flex-wrap justify-between p-5 rounded-lg shadow-sm border1 bg-zinc-100 dark:bg-zinc-900">
    ...
    <div class="flex-1">
      ...
      <div v-if="props.member.friends" class="mt-0.5">{{ props.member.friends.length }} following</div>
