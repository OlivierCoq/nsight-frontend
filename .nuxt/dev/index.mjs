globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Applications/MAMP/htdocs/www/NSIGHT_PROJECT/nsight-frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
...
const getClientManifest = () => import('/Applications/MAMP/htdocs/www/NSIGHT_PROJECT/nsight-frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
