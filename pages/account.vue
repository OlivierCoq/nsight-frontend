<template>
  <v-row id="account" :class="auth.user.preferences.dark_mode ? 'bg-dark' : 'bg-light'">
    <v-col class="h-100">
                        ...
                        <v-col v-else v-for="(address, a) in auth.user.addresses.data" :key="a" cols="12" sm="12" md="5" lg="5" xl="5">
                          ...
                          >
                            ...
                            <div class="w-100 d-flex flex-row justify-start align-start">
                              <v-btn color="info" size="x-small" class="mt-3" @click="state.address.edit_address = true">
                                Edit

                                <v-dialog v-model="state.address.edit_address" max-width="500">
                                  <v-card>
                                    <v-card-title>
                                      Edit Address
                                    </v-card-title>
                                    <v-card-text>
                                      <v-col>
                                        <v-form>
                                          <!-- Form field consisting of inputs for address -->
                                          <v-row>
                                            <v-col cols="12" sm="12" md="12" lg="12" xl="12">
                                              <v-text-field
