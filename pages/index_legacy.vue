  ...
  <v-container fluid id="login_screen">
    <v-row>
      <v-col cols="12" sm="12" md="6" offset-md="3">
        <div
          class="d-flex flex-column justify-center align-center p-3 pmd-5 h-100vh"
        >
          <img
          ...
          <form class="w-100">
            ...
            <div class="mb-3">
              <small class="text-light"
                ...
                <NuxtLink
                  to="/forgot-password"
                  class="text-info fw-bolder text-decoration-none"
                  >Let's fix that.
                </NuxtLink>
              </small>
            </div>
            <v-alert v-if="state.errors.length" color="error">
              ...
              <ul class="list-group-danger p-0">
                <li v-for="(error, a) in state.errors" :key="a">
                  {{ error }}.
                </li>
              </ul>
            </v-alert>
                ...
                <client-only>
                  <figure v-if="state.quote">
                    ...
                    <figcaption class="blockquote-footer">
                      <a
                        :href="
                          state.quote.link ? state.quote.link : 'javascript:(0)'
                        "
